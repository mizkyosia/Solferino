...
void MyApplication::loop()
{
    ...
    ImGui::SliderFloat("Camera angle", &cameraAngle, 0.f, glm::pi<float>() * 2);
    ...
    view = glm::lookAt(glm::vec3(20.0 * sin(cameraAngle), 20.0 * cos(cameraAngle), 20.0),
    ...
    shaderProgram.setUniform("baseColor", color);
